...
def plot_results(dt_res, svm_res, rf_res, output):
    ...
    fig, ax = plt.subplots()
    dt_best_accs = ax.bar(x1, dt_best_acc,
            width, edgecolor="black")
    dt_worst_accs = ax.bar(x1, dt_worst_acc,
            width, edgecolor="black")
    svm_best_accs = ax.bar(x2, svm_best_acc,
            width, edgecolor="black")
    svm_worst_accs = ax.bar(x2, svm_worst_acc,
            width, edgecolor="black")
    rf_best_accs = ax.bar(x3, [80, 90, 70],
            width, edgecolor="black")
    rf_worst_accs = ax.bar(x3, [65, 70, 60],
            width, edgecolor="black")
    ...
    # Plot every bar in the corresponding group
    fig, ax = plt.subplots()
    dt_best_precs = ax.bar(x1, dt_best_prec,
            width, edgecolor="black")
    dt_worst_precs = ax.bar(x1, dt_worst_prec,
            width, edgecolor="black")
    svm_best_precs = ax.bar(x2, svm_best_prec,
            width, edgecolor="black")
    svm_worst_precs = ax.bar(x2, svm_worst_prec,
            width, edgecolor="black")
    rf_best_precs = ax.bar(x3, [80, 90, 70],
            width, edgecolor="black")
    rf_worst_precs = ax.bar(x3, [65, 70, 60],
            width, edgecolor="black")
    ...
    # Plot every bar in the corresponding group
    fig, ax = plt.subplots()
    dt_best_recs = ax.bar(x1, dt_best_rec,
            width, edgecolor="black")
    dt_worst_recs = ax.bar(x1, dt_worst_rec,
            width, edgecolor="black")
    svm_best_recs = ax.bar(x2, svm_best_rec,
            width, edgecolor="black")
    svm_worst_recs = ax.bar(x2, svm_worst_rec,
            width, edgecolor="black")
    rf_best_recs = ax.bar(x3, [80, 90, 70],
            width, edgecolor="black")
    rf_worst_recs = ax.bar(x3, [65, 70, 60],
            width, edgecolor="black")
