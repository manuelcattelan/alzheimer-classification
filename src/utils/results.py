...
def plot_tuning_results(dt, svm, rf, output):
    ...
    dt_rows_to_plot = round(dt_tuning_full.shape[0] * 5/100)
    svm_rows_to_plot = round(svm_tuning_full.shape[0] * 5/100)
    rf_rows_to_plot = round(rf_tuning_full.shape[0] * 5/100)
