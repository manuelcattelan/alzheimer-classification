def compute_classifier_performance(split_cm, split_train_time, split_test_time):
    ...
    return (accuracy, precision, recall, f1_score), task_train_time, task_test_time

def compute_best_task_performance(tasks_performance, tasks_train_time, tasks_test_time, p_metric):
    ...
    best_task_metric_value = max([ results[metric] for results in tasks_performance ])
    best_task_index = [ results[metric] for results in tasks_performance ].index(best_task_metric_value)
    ...
    return (best_task_accuracy, best_task_precision, best_task_recall, best_task_f1score), best_task_train_time, best_task_test_time, best_task_index
